...
import mcpServerRouter from './api/mcp-server.js'; // LIV8 OS MCP Server - external platform integration
...
app.use('/api/mcp', rateLimitPresets.api, mcpServerRouter); // LIV8 OS MCP Server - external platform integration
